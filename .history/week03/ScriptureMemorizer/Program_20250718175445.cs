...
// 3. Smart Word Hiding: When selecting words to hide, the program now only selects words that are not already hidden.
//    This ensures unique words are targeted each round until all are hidden.
